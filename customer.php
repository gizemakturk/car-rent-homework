...
<div class="w3-content w3-margin-top" style="max-width:1400px;">
  ...
  <div class="w3-row-padding">
   ...
   ?>
    ...
    <h6 class='w3-text-teal'><i class='fa fa-calendar fa-fw w3-margin-right'></i>". $bookrow['startdate']." <span class='w3-tag w3-teal w3-round'>".$bookrow['enddate']."</span></h6>\
    <h6 class='w3-text-teal'><i class='fa fa-location fa-fw w3-margin-right'></i>". $bookrow['pickupaddress']." <span class='w3-tag w3-teal w3-round'>".$bookrow['returnaddress']."</span></h6>\
